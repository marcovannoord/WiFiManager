...
const char HTTP_ROOT_MAIN[]        PROGMEM = "<h1>{v}</h1><h3>WiFi Configuration</h3>";
const char * const HTTP_PORTAL_MENU[] PROGMEM = {
"<form action='/wifi'    method='get'><button>Configure WiFi</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>Configure WiFi (No Scan)</button></form><br/>\n", // MENU_WIFINOSCAN
"<form action='/info'    method='get'><button>Info</button></form><br/>\n", // MENU_INFO
"<form action='/param'   method='get'><button>Settings</button></form><br/>\n",//MENU_PARAM
"<form action='/close'   method='get'><button>Close</button></form><br/>\n", // MENU_CLOSE
"<form action='/restart' method='get'><button>Restart</button></form><br/>\n",// MENU_RESTART
"<form action='/exit'    method='get'><button>Save and Exit</button></form><br/>\n",  // MENU_EXIT
...
const char HTTP_SAVED[]            PROGMEM = "<div class='msg'>Trying to connect sensor to network.<br/></div><br>This might take up to one minute.<br>"
...
"button,input[type='button'],input[type='submit']{cursor:pointer;border:0;background-color:#00a99d;color:#fff;line-height:2.4rem;font-size:1.2rem;width:100%}"
"input[type='file']{border:1px solid #00a99d}"
".wrap {text-align:left;display:inline-block;min-width:260px;max-width:500px}"
// links
"a{color:#000;font-weight:700;text-decoration:none}a:hover{color:#00a99d;text-decoration:underline}"
// quality icons
...
// msg callouts
".msg{padding:20px;margin:20px 0;border:1px solid #eee;border-left-width:5px;border-left-color:#777}.msg h4{margin-top:0;margin-bottom:5px}.msg.P{border-left-color:#00a99d}.msg.P h4{color:#00a99d}.msg.D{border-left-color:#dc3630}.msg.D h4{color:#dc3630}"
// lists
